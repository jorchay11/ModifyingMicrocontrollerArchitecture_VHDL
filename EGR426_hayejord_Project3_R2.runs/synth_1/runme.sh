...
HD_PWD='C:/Users/19896/EGR426_hayejord_Project3_R2/EGR426_hayejord_Project3_R2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Project3_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Project3_top.tcl
