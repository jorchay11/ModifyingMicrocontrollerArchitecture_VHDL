...
set rc [catch {
  ...
  add_files -quiet C:/Users/19896/EGR426_hayejord_Project3_R2/EGR426_hayejord_Project3_R2.runs/synth_1/Project3_top.dcp
  ...
  link_design -top Project3_top -part xc7s50csga324-1
...
set rc [catch {
  ...
  phys_opt_design 
  write_checkpoint -force Project3_top_physopt.dcp
...
set rc [catch {
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file Project3_top_timing_summary_routed.rpt -pb Project3_top_timing_summary_routed.pb -rpx Project3_top_timing_summary_routed.rpx -warn_on_violation "
  ...
  create_report "impl_1_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file Project3_top_bus_skew_routed.rpt -pb Project3_top_bus_skew_routed.pb -rpx Project3_top_bus_skew_routed.rpx"
