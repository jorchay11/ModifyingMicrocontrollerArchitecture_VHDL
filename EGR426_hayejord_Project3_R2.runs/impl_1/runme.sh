...
HD_PWD='C:/Users/19896/EGR426_hayejord_Project3_R2/EGR426_hayejord_Project3_R2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Project3_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Project3_top.tcl -notrace
